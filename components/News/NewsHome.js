    ...
    return (
        <div className="bg-gradient-to-r from-orange-100 to-orange-300 p-4 border-r border-white">
            <div className="flex border-b-2 w-full border-white mb-2">
                <div className="flex text-xl sm:text-2xl font-bold text-black p-2 px-4 sm:px-8 border-r border-white">
                    Top Stories
                </div>
                <div className="flex text-xl sm:text-2xl font-bold text-black p-2 px-4 sm:px-6">
                    Risers News For You
                </div>
            </div>

            <div className="flex flex-col lg:flex-row flex-wrap rounded-xl p-2 sm:p-4 gap-4">
                <div className="flex flex-col sm:flex-row flex-1 p-2 sm:p-6 gap-4 lg:border-r border-white">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="text-base sm:text-lg font-medium text-gray-700 space-y-2">
                    ...
                    {rest.map((story) => (
                        <div key={story.title} className="flex gap-4 p-2">
                            ...
                            <div className="flex flex-col gap-1">
                                <h1 className="font-bold text-lg sm:text-xl uppercase text-black">
                                    {story.title}
                                </h1>
